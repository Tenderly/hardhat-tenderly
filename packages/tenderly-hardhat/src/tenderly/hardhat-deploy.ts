...
function wrapDeploy(deployFunc: typeof hhDeploy, tenderly: TenderlyPlugin): typeof hhDeploy {
  return async function (name: string, options: DeployOptions): Promise<DeployResult> {
