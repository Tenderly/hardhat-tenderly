...
import { TdlyContract } from "../types/TdlyContract";
import { TdlyContractFactory } from "../types/TdlyContractFactory";

export function extendEthers(hre: HardhatRuntimeEnvironment): void {
  if (
    "ethers" in hre &&
...
declare function getContractFactoryName(
  name: string,
  signerOrOptions?: ethers.Signer | FactoryOptions,
): Promise<ethers.ContractFactory>;

declare function getContractFactoryABI(
  abi: any[],
...
declare function getContractAt(
  nameOrAbi: string | any[],
  address: string,
  signer?: ethers.Signer,
): Promise<ethers.Contract>;
...
declare function getContractFactoryFromArtifact(
  artifact: Artifact,
  signerOrOptions?: ethers.Signer | FactoryOptions,
): Promise<ethers.ContractFactory>;
...
declare function getContractAtFromArtifact(
  artifact: Artifact,
  address: string,
  signer?: ethers.Signer,
): Promise<ethers.Contract>;
