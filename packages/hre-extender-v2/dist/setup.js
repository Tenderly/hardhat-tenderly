...
function setup() {
    (0, config_1.extendEnvironment)(async (hre) => {
        ...
        if ((0, populate_hardhat_verify_config_1.shouldPopulateHardhatVerifyConfig)(hre)) {
            ...
            const etherscanConfig = await (0, populate_hardhat_verify_config_1.findEtherscanConfig)(hre);
            ...
            await (0, populate_hardhat_verify_config_1.populateHardhatVerifyConfig)(hre);
        }
